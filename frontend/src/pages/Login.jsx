...
export const Login = () => {
  ...
  return (
    <main className="min-h-dvh bg-[#33231c] text-[#fff7ed]">
      <div className="relative isolate flex min-h-dvh items-center justify-center overflow-hidden bg-[radial-gradient(circle_at_18%_18%,rgba(255,157,77,0.12),transparent_32%),radial-gradient(circle_at_82%_16%,rgba(255,100,54,0.10),transparent_30%),radial-gradient(circle_at_62%_82%,rgba(143,79,38,0.20),transparent_38%),#33231c] px-4 py-8 shadow-[inset_0_0_90px_rgba(16,8,5,0.34)] sm:px-6 lg:py-10">
          ...
          <div className="relative overflow-hidden border-b border-amber-100/[0.08] bg-[linear-gradient(135deg,rgba(255,100,54,0.12),rgba(255,255,255,0.022)),#1b110de8] p-7 sm:p-9 lg:border-b-0 lg:border-r lg:border-amber-100/[0.07] lg:p-12">
            ...
            <div className="relative z-10 mt-12 max-w-sm lg:mt-14">
              ...
              <p className="mt-5 text-sm leading-6 text-[#d2c2b5]">
                Return to your tasks, modules, schedule, and dashboard with a calmer grip on the week ahead.
              </p>
            </div>
            ...
            <div className="mx-auto flex w-full max-w-md flex-col justify-center">
              <div className="mb-8">
                ...
                <p className="mt-3 text-sm leading-6 text-[#b9a99d]">
                  Sign in to continue your planner.
                </p>
              </div>
